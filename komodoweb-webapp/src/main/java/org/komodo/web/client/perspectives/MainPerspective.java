 ...
 */
package org.komodo.web.client.perspectives;
...
/**
 * The MainPerspective for Komodo Web application
 */
@ApplicationScoped
...
public class MainPerspective {
    ...
    public PerspectiveDefinition buildPerspective() {
        ...
        perspective.getRoot().addPart(new PartDefinitionImpl(new DefaultPlaceRequest(Constants.KOMODO_WORKSPACE_SCREEN)));
