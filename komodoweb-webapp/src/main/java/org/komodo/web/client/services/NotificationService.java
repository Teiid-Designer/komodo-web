...
import org.komodo.web.client.animations.FadeOutAnimation;
import org.komodo.web.client.animations.MoveAnimation;
import org.komodo.web.client.events.MouseInEvent;
import org.komodo.web.client.events.MouseOutEvent;
import org.komodo.web.client.resources.AppResource;
import org.komodo.web.client.services.notification.Notification;
import org.komodo.web.client.services.notification.NotificationConstants;
import org.komodo.web.client.services.notification.NotificationWidget;
import org.komodo.web.share.beans.NotificationBean;
import org.komodo.web.share.beans.NotificationType;
...
public class NotificationService {
    ...
    public NotificationService() {
    	AppResource.INSTANCE.css().komodoWebStyle().ensureInjected();
    	//AppResource.INSTANCE.css().rcueStyle().ensureInjected();
    }
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, String message, KomodoUiException exception) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(String.valueOf(notificationCounter++));
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, KomodoUiException exception) {
    ...
    public final void sendErrorNotification(String title, Throwable exception) {
        if (exception instanceof KomodoUiException) {
            sendErrorNotification(title, (KomodoUiException) exception);
        } else {
     ...
     * @param exception
     */
    public final void completeProgressNotification(String uuid, String title, KomodoUiException error) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(uuid);
    ...
    public void completeProgressNotification(String uuid, String title, Throwable error) {
        if (error instanceof KomodoUiException) {
            completeProgressNotification(uuid, title, (KomodoUiException) error);
        } else {
            completeProgressNotification(uuid, title, new KomodoUiException(error));
        }
    }
    ...
    private void createNotificationWidget(final Notification notification) {
        ...
        widget.addMouseInHandler(new org.komodo.web.client.events.MouseInEvent.Handler() {
            @Override
        ...
        widget.addMouseOutHandler(new org.komodo.web.client.events.MouseOutEvent.Handler() {
            @Override
