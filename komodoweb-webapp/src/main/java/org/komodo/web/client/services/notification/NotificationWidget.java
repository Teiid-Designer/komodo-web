 ...
 */
package org.komodo.web.client.services.notification;
...
import org.komodo.web.client.events.MouseInEvent.HasMouseInHandlers;
import org.komodo.web.client.events.MouseOutEvent.HasMouseOutHandlers;
...
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    public HandlerRegistration addMouseOutHandler(
            org.komodo.web.client.events.MouseOutEvent.Handler handler) {
    ...
    public HandlerRegistration addMouseInHandler(
    		org.komodo.web.client.events.MouseInEvent.Handler handler) {
