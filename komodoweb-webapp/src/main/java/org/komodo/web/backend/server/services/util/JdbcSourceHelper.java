...
public class JdbcSourceHelper {
     ...
     */
    public List<String> getJdbcSourceNames(boolean teiidOnly) throws KomodoUiException {
    	// Get DataSources Map
     ...
     */
    public boolean isTeiidSource(DataSource dataSource) throws KomodoUiException {
    	boolean isVdb = false;
     ...
     */
    public Map<String,DataSource> getDataSourceMap( ) throws KomodoUiException {
