...
import org.komodo.web.backend.server.services.util.VdbHelper;
import org.komodo.web.share.Constants;
import org.komodo.web.share.TranslatorHelper;
import org.komodo.web.share.beans.DataSourceDetailsBean;
...
import org.komodo.web.share.beans.VdbModelBean;
...
public class TeiidService implements ITeiidService {
    ...
    public List<DataSourcePageRow> getDataSources( final String filters, final String srcVdbPrefix ) {
    	...
    	for ( String dsName : filteredDsList ) {
    		...
    		if(hasSrcVdbList.get(i)) {
    			...
    			String connectionStatus = Constants.OK;
    ...
    private String getTranslatorForSrcVdb(String srcVdbName) throws KomodoUiException {
...
//    }
    ...
    public List<DataSourcePropertyBean> getDataSourceTypeProperties(String typeName) throws KomodoUiException {
     ...
     */
    public String getDataSourceType(String dsName) throws KomodoUiException {
    	Properties dsProps = null;
    	try {
			dsProps = clientAccessor.getClient().getDataSourceProperties(dsName);
		} catch (AdminApiClientException e) {
    ...
    public void deleteDataSource(String dsName) throws KomodoUiException {
    	try {
    ...
    public void createDataSource(DataSourceDetailsBean bean) throws KomodoUiException {
    ...
    public void createDataSourceWithVdb(DataSourceWithVdbDetailsBean bean) throws KomodoUiException {
    ...
    private void deleteVdbs(Collection<String> vdbNames) throws KomodoUiException {
    	try {
    ...
    private void deleteVdb(String vdbName) throws KomodoUiException {
    	try {
     ...
     */
    private String deploySourceVDB(String sourceVDBName, String modelName, String dataSourceName, String jndiName, String translator) throws KomodoUiException {
    	try {
     ...
     */
    private String getVDBStatusMessage(String vdbName) throws KomodoUiException {
    ...
    private String getSourceJndiName(String dataSourceName) throws KomodoUiException {
    	// Get Data Source properties
    	Properties dsProps = null;
    	try {
     ...
     */
    private void createVdbDataSource(String vdbName) throws KomodoUiException {
     ...
     */
    private void addDataSource(String sourceName, String templateName, Properties sourceProps) throws KomodoUiException {
    	try {
    ...
    public void deployVdbWithSource(String vdbName, InputStream vdbContent) throws KomodoUiException {
		// Deployment name for vdb must end in '-vdb.xml'
		String deploymentName = vdbName + Constants.DYNAMIC_VDB_SUFFIX;
    ...
    public void deleteDynamicVdbsWithPrefix(String vdbPrefix) throws KomodoUiException {
		...
		try {
    		...
    		throw new KomodoUiException(e1);
		}
    ...
    private List<String> getDataServiceVdbNames( ) throws KomodoUiException {
    	// Collect all of the Service VDB names
    	List<String> svcVdbNames = null;
    	try {
    		svcVdbNames = clientAccessor.getClient().getDataServiceVdbNames();
    ...
    public VdbDetailsBean getVdbDetails(String vdbName, int page) throws KomodoUiException {
